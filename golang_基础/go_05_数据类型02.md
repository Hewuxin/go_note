...
![image-20221024200056304](go_05_数据类型02.assets/image-20221024200056304.png)
...
![image-20221024201131655](go_05_数据类型02.assets/image-20221024201131655.png)

也可以添加参数

![image-20221024201631645](go_05_数据类型02.assets/image-20221024201631645.png)

##### 4.5自执行函数

![image-20221024201831020](go_05_数据类型02.assets/image-20221024201831020.png)
...
![image-20221024202243839](go_05_数据类型02.assets/image-20221024202243839.png)

![image-20221024202256609](go_05_数据类型02.assets/image-20221024202256609.png)

##### 5.2 类型方法

项目开发中可以为type声明的类型编写一些方法，从而实现`对象.方法`的操作。

![image-20221024203051227](go_05_数据类型02.assets/image-20221024203051227.png)

![image-20221024203124912](go_05_数据类型02.assets/image-20221024203124912.png)

结构体也是基于type声明的类型，所以也可以使用次方式为结构体定义一些方法。

   ![image-20221024203201989](go_05_数据类型02.assets/image-20221024203201989.png)
...
![image-20221024204240064](go_05_数据类型02.assets/image-20221024204240064.png)

![image-20221024204521137](go_05_数据类型02.assets/image-20221024204521137.png)
...
![image-20221024205256084](go_05_数据类型02.assets/image-20221024205256084.png)
...
![image-20221024205529724](go_05_数据类型02.assets/image-20221024205529724.png)

![image-20221024210929765](go_05_数据类型02.assets/image-20221024210929765.png)

由于接口只是代指这些数据类型（在内部其实是转换为了接口类型），想要再获取数据中的值时，需要再将接口转换为指定的数据类型。

![image-20221024211226482](go_05_数据类型02.assets/image-20221024211226482.png)

 ![image-20221024211536587](go_05_数据类型02.assets/image-20221024211536587.png)
...
示例1：
 ...
 ![image-20221024211940190](go_05_数据类型02.assets/image-20221024211940190.png)

![image-20221024212034457](go_05_数据类型02.assets/image-20221024212034457.png) 

![image-20221024212215513](go_05_数据类型02.assets/image-20221024212215513.png)

###### 练习题

在项目中实现注册成功之后向用户发送：邮件、微信的消息提醒。

 ![image-20221024212419120](go_05_数据类型02.assets/image-20221024212419120.png)

![image-20221024212434050](go_05_数据类型02.assets/image-20221024212434050.png)